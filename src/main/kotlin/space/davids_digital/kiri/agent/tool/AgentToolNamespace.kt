 ...
 *
 * For top-level providers, final method name for the agent will be constructed as `$namespace_$methodName`.
 ...
 * `$namespace_$subNamespace_$methodName`, and so on.
 */
...
annotation class AgentToolNamespace(
     ...
     *
     * Namespace should only contain alphanumeric characters.
